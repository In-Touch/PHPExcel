...
class PHPExcel_Reader_HTML extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
     ...
     *
     * @param 	string|DOMDocument 		$pFilename
     * @return 	PHPExcel
    ...
    public function load($pFilename)
    {
        ...
        if ($pFilename instanceof DOMDocument) {
            return $this->loadDOMIntoExisting($pFilename, $objPHPExcel);
        }
        else {
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
    ...
    public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
    {
        ...
        $loaded = $dom->loadHTMLFile($pFilename, PHPExcel_Settings::getLibXmlLoaderOptions() | LIBXML_NOERROR | LIBXML_NOWARNING);
        if ($loaded === FALSE) {
        ...
        return $this->loadDOMIntoExisting($dom, $objPHPExcel);
    }
     ...
     * @throws 	PHPExcel_Reader_Exception
     */
    public function loadDOMIntoExisting(DOMDocument $dom, PHPExcel $objPHPExcel)
    {
        // Create new PHPExcel
